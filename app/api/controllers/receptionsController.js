...
export async function createReception(req, res) {
  ...
  try {
    ...
    // Generate unique reception number REC-YYYY-XXX
    ...
    const reception = await Reception.create({
      ...
      observation,
      status: 'validee' // validated immediately as per cahier des charges
    }, { transaction });

    // Process items and increment stock in real-time
    for (const item of items) {
      ...
      // Record real-time stock movement
