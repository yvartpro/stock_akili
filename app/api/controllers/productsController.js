...
export async function getProducts(req, res) {
  try {
    ...
    // Filter in JS if lowStock to ensure compatibility across all DB engines
...
function sequelizeWhereCurrentStockLessThanMinThreshold() {
  return {
...
// Section 11: Products are NEVER deleted, they are marked with appropriate status
